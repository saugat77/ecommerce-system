				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="phone: 98********" href="#" ><span class="mobile"></span>Phone: 98********</a>
								</li>
							</ul>
						</div>
						<div class="topbar-menu right-menu">
								...
								<ul>
									<li class="menu-item lang-menu menu-item-has-children parent">
										...
										<ul class="submenu lang" >
											<li class="menu-item" ><a title="Dashboard" href="{{ route('admin.dashboard')}}"><i class="fa fa-tachometer" aria-hidden="true"></i> Dashboard</a></li>
											<li class="menu-item">
												<a title="Categories" href="{{route('admin.categories')}}"><i class="fa fa-chevron-circle-down" aria-hidden="true"></i> Categories</a>
											</li>
											<li class="menu-item">
												<a title="Products" href="{{ route('admin.products')}}"><i class="fa fa-product-hunt" aria-hidden="true"></i> Products</a>
											</li>
											<li class="menu-item" style="white-space: nowrap;">
												<a title="Manage Home Slider" href=" {{route('admin.homeslider')}} " ><i class="fa fa-font-awesome" aria-hidden="true"></i> Manage Home Slider</a>
											</li>
											<li class="menu-item" style="white-space: nowrap;">
												<a title="Manage Home Categories" href=" {{route('admin.homecategories')}} " ><i class="fa fa-chevron-circle-down" aria-hidden="true"></i> Manage Home Categories</a>
											</li>
											<li class="menu-item" style="white-space: nowrap;">
												<a title="sale setting" href=" {{route('admin.sale')}} " ><i class="fa fa-calendar" aria-hidden="true"></i> Sale Setting</a>
											</li>
											<li class="menu-item" style="white-space: nowrap;">
												<a title="all order" href=" {{route('admin.orders')}} " ><i class="fa fa-history" aria-hidden="true"></i> All Orders</a>
											</li>
											<li class="menu-item" style="white-space: nowrap;">
												<a title="all user" href=" {{route('admin.user')}} " ><i class="fa fa-user" aria-hidden="true"></i> All Users</a>
											</li>
											<li class="menu-item" >
							...
							<ul>
								...
								<li class="menu-item lang-menu menu-item-has-children parent">
									...
									<ul class="submenu lang" >
										<li class="menu-item" ><i class="fa fa-tachometer" aria-hidden="true"></i> <a title="Dashboard" href="{{ route('user.dashboard')}}">Dashboard</a></li>
										<li class="menu-item" style="white-space: nowrap;">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="{{ asset ('assets/images/logo-top-1.jpg') }}" alt="mercado"></a>
						</div>
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">KTM NEPAL</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">+977-1234567890</p>
											</li>
											<li>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										<span class="desc">Call Us Free</span>
										<b class="phone-number">+977-1234567890</b>
									</div>
								</div>
							</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											<li><a href="twitter.com" class="link-to-item" title="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
											<li><a href="facebook.com" class="link-to-item" title="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
											<li><a href="#" class="link-to-item" title="pinterest"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
											<li><a href="instagram.com" class="link-to-item" title="instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
